jQuery(document).ready(function ($) {
    ...
    jQuery(".accordion .accordion-title").each(function () {
        ...
        jQuery(this).parent().find(".accordion-title i").css({
            "color": i_color
        });
        var i_click = jQuery(this).parent().attr("i_click");
        jQuery(this).parent().find(".accordion-title.active i").css({
            "color": i_click
        });
        jQuery(this).click(function () {
            ...
            if (jQuery(this).parent().hasClass("acc-style-4")) {
                jQuery(this).parent().find(".accordion-title.active").next().css({
    ...
    jQuery("ul.tabs li").each(function () {
        ...
        jQuery(this).find("a.current i").css({
            "color": i_click
        });
        ...
        jQuery(this).click(function () {
            var i_color = jQuery(this).parent().parent().attr("i_color");
            jQuery(this).parent().find("a i").css({
                "color": i_color
            });
            var i_click = jQuery(this).parent().parent().attr("i_click");
            jQuery(this).find("a.current i").css({
        ...
        if (jQuery(this).parent().parent().hasClass("tabs-vertical")) {
            ...
            jQuery(this).parent().parent().find("div.tab-inner-warp").css({
