jQuery.fn.tag = function (options) {
    ...
    jQuery(this).each(function () {
        if ((seperator = jQuery(this).attr('data-seperator')) != '') options.seperator = seperator;
        var create_tag = function (text) {
            ...
            var close = jQuery('<a/>', {
                tabindex: '-1'
            }).addClass(options.style.remove).append(close_text).click(function () {
        ...
        if (input.is(':input')) {
            ...
            add.bind('keyup', function () {
                ...
                if (jQuery(this).val() == '' && (key == 8 || key == 46)) {
